...
class Exp2; // exp3 && exp2

class Exp3; // exp4 | exp3

class Exp4; // exp5 & exp4

class Exp5; // exp6 == exp5 | exp6 != exp5

class Exp6; // exp7 < exp6 | exp7 > exp6 | exp7 <= exp6 | exp7 >= exp6

class Exp7; // exp8 << exp7 | exp8 >> exp7

class Exp8; // exp9 + exp8 | exp9 - exp8

class Exp9; // exp10 / exp9 | exp10 * exp9

class Exp10;// !exp11 | -exp11

class Exp11;// int-num | id | (exp) | id[exp]
...
public:
    ...
    static shared_ptr<Program> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<VarDeclarations> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<VarDeclaration> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<DeclarationList> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Declaration> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<CodeBlock> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Statements> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Statement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<ControlStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<ReadWriteStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<AssignStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<IfStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<IfStmt> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<WhileStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<DoWhileStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<ReturnStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<ReadStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<WriteStatement> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp2> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp3> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp4> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp5> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp6> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp7> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp8> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp9> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp10> parse(Scanner &scanner, Translator &translator);
...
public:
    ...
    static shared_ptr<Exp11> parse(Scanner &scanner, Translator &translator);
